package com.wshsoft.quartz.controller;
...
public class SysJobController extends BaseController
{
    ...
    @SysLog(title = "定时任务", businessType = BusinessType.EXPORT)
    ...
    @SysLog(title = "定时任务", businessType = BusinessType.DELETE)
     ...
     * 任务调度状态修改
     */
    @SysLog(title = "定时任务", businessType = BusinessType.UPDATE)
     ...
     * 新增保存调度
     */
    @SysLog(title = "定时任务", businessType = BusinessType.INSERT)
